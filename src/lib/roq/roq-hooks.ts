...
export function useSickLeaveFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSickLeaveFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sick_leave.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSickLeaveCount<T extends Prisma.sick_leaveCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.sick_leaveCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useSickLeaveCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sick_leave.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSickLeaveFindManyWithCount<
  T extends Prisma.sick_leaveFindManyArgs,
  R extends { data: GetFindResult<Prisma.$sick_leavePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.sick_leaveFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSickLeaveFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sick_leave.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSickLeaveFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSickLeaveFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.sick_leave.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
