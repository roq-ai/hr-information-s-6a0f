  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'payroll.count', 'sick_leave.count', 'vacation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.termination_date ? format(record?.termination_date, 'dd-MM-yyyy') : '',
    },
    { id: 'position', header: 'Position', accessorKey: 'position' },
    { id: 'salary', header: 'salary', accessorKey: 'salary' },
    { id: 'adress', header: 'Adress', accessorKey: 'adress' },
    ...
    { id: 'contract_type', header: 'Contract Type', accessorKey: 'contract_type' },
    { id: 'employee_status', header: 'Employee Status', accessorKey: 'employee_status' },
    ...
    hasAccess('payroll', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('sick_leave', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'sick_leave',
          header: 'Sick Leave',
          accessorKey: 'sick_leave',
          cell: ({ row: { original: record } }: any) => record?._count?.sick_leave,
        }
      : null,
