...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HR Information System v1`}</title>

        <meta
          name="description"
          content="Experience seamless employee management with HR Information System v1 - Your ultimate solution for employee data, vacations, and payroll handling"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1531545514256-b1400bc00f31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUnxlbnwwfHx8fDE2OTkwMTY2MTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`HR Information System v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless employee management with HR Information System v1 - Your ultimate solution for employee data, vacations, and payroll handling`}
            </Text>
            <Box
