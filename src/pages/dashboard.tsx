...
import { useRoqPlatformUserProfiles, useVacationCount, useEmployeeCount, useSickLeaveCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const sickLeaveStat = useSickLeaveCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Sick Leaves',
      result: sickLeaveStat?.data,
      isLoading: sickLeaveStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
