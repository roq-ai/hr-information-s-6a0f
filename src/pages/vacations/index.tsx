...
import { useRoqClient, useVacationFindManyWithCount } from 'lib/roq';
...
export function VacationListPage(props: VacationListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useVacationFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.vacation.delete({ where: { id } });
      await mutate();
    } catch (error) {
